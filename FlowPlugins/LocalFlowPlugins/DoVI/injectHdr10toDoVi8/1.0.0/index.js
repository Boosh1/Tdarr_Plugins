    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                shellCmd2 = "/app/server/Tdarr/dovi_tool generate -j \"".concat(extraJsonPath, "\" --hdr10plus-json \"").concat(metaFilePath, "\" -o \"").concat(rpuBinPath, "\"");
            ...
            case 2:
                ...
                shellCmd3 = "/app/server/Tdarr/dovi_tool inject-rpu -i \"".concat(blHevcPath, "\" --rpu-in \"").concat(rpuBinPath, "\" -o \"").concat(outHevcPath, "\"");
