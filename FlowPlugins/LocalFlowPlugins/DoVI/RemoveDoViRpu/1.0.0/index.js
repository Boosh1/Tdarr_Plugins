...
var details = function () {
  return {
    name: 'Remove DoVi RPU',
    description: 'Remove Dolby Vision data',
...
var plugin = function (args) {
  return __awaiter(void 0, void 0, void 0, function () {
    var lib, pluginWorkDir, outputFilePath, shellCmd, doviCliArgs, spawnArgs, cli, res;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          outputFilePath = pluginWorkDir + "/" + (0, fileUtils_1.getFileName)(args.originalLibraryFile._id) + ".hevc";
          ...
          shellCmd = "ffmpeg -i \"".concat(args.inputFileObj.file, "\" -y -loglevel error -stats -map 0:v:0 -c:v copy -bsf:v hevc_mp4toannexb -f hevc - | /app/server/Tdarr/dovi_tool remove - -o \"" + outputFilePath + "\"");
