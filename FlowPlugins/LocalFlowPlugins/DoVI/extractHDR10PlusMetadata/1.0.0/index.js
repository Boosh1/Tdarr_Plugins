    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                shellCmd = "ffmpeg -i \"".concat(args.inputFileObj.file, "\" -y -loglevel error -stats -map 0:v:0 -c:v copy -bsf:v hevc_mp4toannexb -f hevc - | /app/server/Tdarr/hdr10plus_tool extract -o \"").concat(outputFilePath, "\" -");
