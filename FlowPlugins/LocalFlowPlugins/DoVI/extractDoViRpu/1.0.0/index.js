...
var plugin = function (args) {
  return __awaiter(void 0, void 0, void 0, function () {
    var lib, pluginWorkDir, outputFilePath, dvProfile, shellCmd, doviCliArgs, spawnArgs, cli, res;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          // Attempt to read DV profile from side_data_list or scanning logic
          dvProfile = 0;
          try {
            var sideData = args.inputFileObj.fileData.side_data_list || [];
            if (Array.isArray(sideData) && sideData.length) {
              dvProfile = sideData[0].dv_profile || 0;
            }
          } catch (err) {
            // fallback - dvProfile=0
          }
          ...
          shellCmd = "ffmpeg -i \"".concat(args.inputFileObj.file, "\" -y -loglevel error -stats -map 0:v:0 -c:v copy -bsf:v hevc_mp4toannexb -f hevc - | /app/server/Tdarr/dovi_tool extract-rpu - -o \"").concat(outputFilePath, "\"");
