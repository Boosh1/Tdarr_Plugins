...
var details = function () {
    return ({
        name: 'Inject HDR10+',
        description: 'Use HDR10+ metadata and inject it to create a HDR10+ file',
        style: {
            borderColor: 'orange',
        },
        tags: 'video',
...
var plugin = function (args) {
    return __awaiter(void 0, void 0, void 0, function () {
        var lib, pluginWorkDir, baseName, jsonPath, inHevcPath, outHevcPath, shellCmd1, cli1, res1, shellCmd2, cli2, res2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    jsonPath = "".concat(pluginWorkDir, "/").concat((0, fileUtils_1.getFileName)(args.originalLibraryFile._id), "_hdr10plus_metadata.json");
                ...
                case 1:
                    ...
                    if (res1.cliExitCode !== 0) {
                        args.jobLog('Failed generating .hevc');
                        throw new Error('hdr10plus_tool generate failed');
                    }

                    // 2) Inject JSON >= HDR10+
                    shellCmd2 = "/app/server/Tdarr/hdr10plus_tool inject -i \"".concat(inHevcPath, "\" -j \"").concat(jsonPath, "\" -o \"").concat(outHevcPath, "\"");
                ...
                case 2:
                    ...
                    if (res2.cliExitCode !== 0) {
                        args.jobLog('Failed injecting JSON');
                        throw new Error('hdr10plus_tool inject failed');
                    }
